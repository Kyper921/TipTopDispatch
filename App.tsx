...
const App: React.FC = () => {
  ...
  const handleClearTrackedVehicleId = (index: number) => {
    setTrackedVehicleIds(prev => {
      const next = [...prev];
